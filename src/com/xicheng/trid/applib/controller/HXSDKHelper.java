 ...
 */
package com.xicheng.trid.applib.controller;
...
import com.xicheng.trid.applib.model.DefaultHXSDKModel;
...
public abstract class HXSDKHelper {
    ...
    public synchronized void notifyForRecevingEvents(){
        ...
        EMChat.getInstance().setAppInited();//注册broadcast receiver 之后，需要调用此函数通知SDK：可以发broadcast 事件
