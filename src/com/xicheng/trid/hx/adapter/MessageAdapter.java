...
import com.xicheng.trid.hx.activity.AlertDialog;
import com.xicheng.trid.hx.activity.BaiduMapActivity;
import com.xicheng.trid.hx.activity.ChatActivity;
import com.xicheng.trid.hx.activity.ContextMenu;
import com.xicheng.trid.hx.activity.ShowBigImage;
import com.xicheng.trid.hx.activity.ShowNormalFileActivity;
import com.xicheng.trid.hx.task.LoadImageTask;
import com.xicheng.trid.hx.utils.DateUtils;
import com.xicheng.trid.hx.utils.ImageCache;
...
public class MessageAdapter extends BaseAdapter{
	...
	private static final int HANDLER_MESSAGE_REFRESH_LIST = 0;//刷新
	private static final int HANDLER_MESSAGE_SELECT_LAST = 1;//最后一页
	private static final int HANDLER_MESSAGE_SEEK_TO = 2;//指定位置
	...
	private Long startTime = 0L;//该对话建立的时间
	...
	public MessageAdapter(Context context, String username, int chatType) {
		...
		//get the conversation with "username"
		this.conversation = EMChatManager.getInstance().getConversation(username);
		this.startTime  = UserUtils.getUserInfor(username).getAvatar();
	}
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		UserUtils.setUserAvatar(message, holder.iv_avatar,startTime);
...
//	}
	...
	public static class ViewHolder {
		...
		ProgressBar pb;
		ImageView staus_iv;
		RoundProgressBarWidthNumber iv_avatar;//用户自己的头像
		TextView tv_usernick;//所接收消息的发送者昵称
		ImageView playBtn;
		TextView timeLength;
		TextView size;
