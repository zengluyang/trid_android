package com.xicheng.trid.timepicker;

import java.util.Calendar;

import com.xicheng.trid.R;
import com.xicheng.trid.timepicker.NumberPicker.OnValueChangeListener;
...
public class TimePicker extends FrameLayout implements OnClickListener {
    ...
    private String[] mDayDisplay = new String[3]; 
	...
	public TimePicker(Context context, AttributeSet attrs) {
		...
		dayPicker = (NumberPicker) findViewById(R.id.time_day);
		...
		dayPicker.setDisplayedValues(mDayDisplay);
	...
	public String getTime() {
		String time = "";
		if (is24Hour) {
			time = mDayDisplay[ dayPicker.getValue()]+" "+hourPicker.getValue() + ":" + minPicker.getValue();
		} else {
